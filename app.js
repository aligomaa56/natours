...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self' https://js.stripe.com; style-src 'self' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' ws://localhost:* chrome://resources chrome://theme; frame-src 'self' https://js.stripe.com;"
  );
  next();
});
...
// Add Stripe webhook checkout route
